...
const First_Page = () => {
    ...
    return (
        <div className='relative h-screen w-full overflow-hidden'>
            <img src="./src/assets/0.jpg" className='absolute inset-0 h-full w-full object-cover -z-10 hidden 2xl:block' alt="" />
            <img src="./src/assets/0.jpg" className='absolute inset-0 h-full w-full object-cover -z-10 hidden md:block 2xl:hidden' alt="" />
            <img src="./src/assets/md0.jpg" className='absolute inset-0 h-full w-full object-cover -z-10 block md:hidden' alt="" />
            <img src="./src/assets/2.png" className='absolute top-10 left-0 w-full h-full opacity-100' alt="" />
            <div ref={Devref} className=' h-full w-full bg-linear-to-r from-black via-black to-transparent flex items-center justify-center 2xl:justify-start px-4 sm:px-8 md:px-12 2xl:px-40 opacity-90'>
                <div className='flex flex-col text-white text-center 2xl:text-left gap-6 md:gap-8 2xl:gap-10'>
                    ...
                    <div ref={Textref} className='mt-2 md:mt-6 2xl:mt-10'>
                        ...
                        <img src="./src/assets/4.png" className='h-8 sm:h-10 md:h-12 2xl:h-15 w-full' alt=""
                        />
                    </div>
